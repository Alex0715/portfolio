function Work() {
  ...
  <section className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          <p className="hidden md:section-paragraph">I Love playing Football <br></br> I played for several local clubs, school team and also college team and this helps me to take up any situaion sportingly.</p>
          </a>
      </div>
  </section>
</div>

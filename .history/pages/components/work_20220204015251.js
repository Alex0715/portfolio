function Work() {
  ...
  <section className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          <p className="section-paragraph">BackBenchers...An ecom design inspired from amazon india. I used nextJs and Tailwindcss</p>
          </a>
          <a><img src="https://images.unsplash.com/photo-1545235617-9465d2a55698?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" className="w-full bg-nav h-36 lg:h-72 object-cover"/></a>

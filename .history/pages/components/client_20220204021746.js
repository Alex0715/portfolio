function Client() {
  ...
  <section className="w-full">
      ...
      <p className="section-paragraph text-white">I’ve had the pleasure of working with multiple Fortune companies, designing and implementing both frontend and backend.</p>
      ...
      <div className="space-y-12 my-16">
          <div className="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
              ...
              <div className="mb-6 lg:mb-0">
                  <img src="/tlg.png" classNameName="flex flex-grow justify-content items-center"/>
              ...
              <div className="flex flex-wrap justify-center text-center lg:text-left lg:block">
                  ...
                  <div className="w-full lg:w-auto flex flex-wrap justify-center lg:justify-start gap-3 mt-6 mb-8">
                      ...
                      <div className="badge">Website Management</div>
                  </div>

                  <p className="text-secondary">I’ve had the pleasure of working with TLG Gaming. I used to manage the frontend ,seo and website management of their website</p>
                  <p className="text-secondary">From May 2021 till November 2021</p>
              </div>

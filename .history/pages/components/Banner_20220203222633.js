...
function Banner() {
  return (<div className="container mt-10 flex justify-between items-center mx-auto text-white px-8 md:px-14 lg:px-24 w-full">
      <div className="flex flex-wrap md:flex-nowrap">
        <nav className="inline-block lg:mr-20 lg:w-4 fixed left-percentage hidden xl:block">

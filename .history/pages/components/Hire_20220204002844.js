function Hire() {
  ...
  <section className="w-full">
      <h2 id="hire" className="secondary-title text-white">Hire me</h2>
      ...
      <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
          ...
          <div className="mt-12">
              ...
              <p className="text-secondary">07003474297</p>
              <a href="mailto:email@mydomain.com" className="text-secondary underline mt-3 block">arjunbose.ar@gmail.com</a>
              ...
              <div className="flex mt-20 space-x-6">
                  ...
                  <a href="#">
                  <img src="https://img.icons8.com/plasticine/100/000000/instagram-new--v1.png"/>
                  </a>
              </div>
          </div>

function Work() {
  ...
  <section className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          <a><img src="/buycsgo.jpg" className="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover" target="_blank"/>
          <p className="section-paragraph">TLG Gaming <br></br> I used to work as a website manager and also in SEO management.</p>
          </a>
          <a><img src="https://images.unsplash.com/photo-1558655146-d09347e92766?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=764&q=80" className="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover"/>
          <p className="section-paragraph">TLG Gaming <br></br> I used to work as a website manager and also in SEO management.</p>
          </a>
          <a><img src="https://images.unsplash.com/photo-1547119957-637f8679db1e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" className="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover"/>
          <p className="section-paragraph">TLG Gaming <br></br> I used to work as a website manager and also in SEO management.</p>
          </a>
          <a><img src="https://images.unsplash.com/photo-1559028012-481c04fa702d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1336&q=80" className="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover"/>
          <p className="section-paragraph">TLG Gaming <br></br> I used to work as a website manager and also in SEO management.</p>
          </a>
          ...
          <a><img src="https://images.unsplash.com/photo-1545235617-7a424c1a60cc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=880&q=80" className="w-full hidden md:block md:col-span-2 lg:col-span-1 bg-nav h-36 lg:h-72 object-cover"/>
          <p className="section-paragraph">TLG Gaming <br></br> I used to work as a website manager and also in SEO management.</p>
          </a>
      </div>
  </section>

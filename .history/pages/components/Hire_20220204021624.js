  ...
  <section className="w-full">
      ...
      <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
          <div className="space-y-12">
              <div>
                  <label className="text-gray-600 block mb-6 text-xl font-bold">Name</label>
              ...
              <button className="px-6 py-2 bg-theme text-white font-bold rounded-md hover:bg-blue-400">Send it!</button>
          </div>

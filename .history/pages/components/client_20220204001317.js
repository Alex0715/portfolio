function Client() {
  return <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
  <section class="w-full">
      <h2 id="clients" class="secondary-title text-white">Clients</h2>
      ...
      <div class="space-y-12 my-16">
          <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
              ...
              <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
                  <h3 class="text-white text-3xl font-semibold">TLG Gaming</h3>
                  ...
                  <div class="w-full lg:w-auto flex flex-wrap justify-center lg:justify-start gap-3 mt-6 mb-8">
                      ...
                      <div class="badge">Website Management</div>
                  </div>

                  <p class="text-secondary">I’ve had the pleasure of working with TLG Gaming. I used to manage the frontend ,seo and website management of their website</p>
                  <p class="text-secondary">From May 2021 till November 2021</p>
              </div>

function Work() {
  ...
  <section className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          <p className="section-paragraph">Playing Guitar <br></br> I play good guitar, when i am stuck at any problem or solving difficult problems playing it helps me calm down and to focus more.</p>
          </a>
          ...
          <p className="section-paragraph">Building PC <br></br>Being a tech nerd I love assembling computer parts and I made near about 18-20 builds last year for clients, friends and family</p>
          </a>

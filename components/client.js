function Client() {
  ...
  <section className="w-full">
      ...
      <p className="text-white my-6 w-full max-w-3xl ">I’ve had the pleasure of working with multiple Fortune companies, designing and implementing both frontend and backend.</p>
